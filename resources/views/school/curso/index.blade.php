...
<div class="container text-center"><a id="novo" class="btn btn-success mybtn" href="{{route('cursos-create')}}">Novo curso</a></div>
</div>
<div class="container pt-2">
...
<tr>
      ...
      @endif
      <td><a href="{{route('cursos-edit',[$curso->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
